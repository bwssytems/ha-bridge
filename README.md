...
```
#### Response
Only listing the relevant fields that are needed for control of an activity. The example below should be able to represent most activities but not all.
Name |	Type |	Description
-----|-------|-------------
label | string | The name of the Harmony activity.
id | integer | The id of the Harmony activity. 
#### Harmony return activities data example
```
