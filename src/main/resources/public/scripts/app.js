...
app.controller('SystemController', function ($scope, $location, bridgeService, ngDialog) {
    ...
    $scope.addFhemtoSettings = function (newfhemname, newfhemip, newfhemport, newfhemusername, newfhempassword, newfhemwebhook, newfhemsecure, newfhemcsrftoken) {
